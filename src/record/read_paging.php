...
// query records
$stmt = $record->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$record->count();
    $page_url="{$home_url}record/read_paging.php?";
    $paging=$utilities->getPaging($page, $total_rows, $records_per_page, $page_url);
    $records_arr["paging"]=$paging;
